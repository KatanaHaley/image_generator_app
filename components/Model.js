...
//         <Rig>
//           <Triangle color="#8E39EB" scale={0.012} rotation={[0, 0, Math.PI / 3]} />
//           <Triangle color="cyan" scale={0.011} position={[2, 0, -2]} rotation={[0, 0, Math.PI / 3]} />
//           <Triangle color="#D8B3FE" scale={0.009} position={[-2, 0, -2]} rotation={[0, 0, Math.PI / 3]} />
